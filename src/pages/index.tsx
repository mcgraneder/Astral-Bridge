...
const Home: NextPage = () => {
    ...
    return (
        <>
            ...
            <Script async strategy='lazyOnload' src='https://www.googletagmanager.com/gtag/js?id=G-NVG461QN61' />
            <Script async strategy='lazyOnload' src='https://www.googletagmanager.com/gtag/js?id=UA-226398370-1' />
