...
function BottomSheetOptions({
  ...
  return (
    <Transition appear show={open} as={Fragment}>
      <Dialog as='div' className='fixed inset-0 z-[1000000000000000000000000000000] overflow-hidden' onClose={_handleOnClose}>
        <div className='min-h-screen text-center'>
          ...
          <Transition.Child
            ...
            <div className='relative inline-block w-full p-4 overflow-hidden font-semibold text-left text-white align-middle transition-all transform bg-darkBackground rounded-t-3xl'>
              {title && (
                <Dialog.Title
                  as='h3'
